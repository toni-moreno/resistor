...
type AlertIDCfg struct {
	//Alert ID data
	ID           string `xorm:"'id' unique" binding:"Required" json:"alertid"` //Autogenerated with next 4 ids (IDBaseLine-IdProduct-IdGroup-IdNumAlert)
	Active       bool   `xorm:"active" json:"-"`
	BaselineID   string `xorm:"baselineid" binding:"Required" json:"baselineid"`
	ProductID    string `xorm:"productid" binding:"Required" json:"productid"` //FK - > Product_devices
	ProductGroup string `json:"productgroup,omitempty"`
	AlertGroup   string `xorm:"alertgroup" binding:"Required" json:"alertgroup"`
	NumAlertID   int    `xorm:"numalertid" binding:"Required" json:"-"`
	Description  string `xorm:"description" json:"-"`
	//Alert Origin data
	InfluxDB           int64  `xorm:"influxdb" binding:"Required" json:"-"`
	InfluxDBName       string `json:"influxdbname"`
	InfluxRP           string `xorm:"influxrp" binding:"Required" json:"influxrp"`
	InfluxMeasurement  string `xorm:"influxmeasurement" binding:"Required" json:"influxmeasurement"`
	TagDescription     string `xorm:"tagdescription" json:"-"`
	InfluxFilter       string `xorm:"influxfilter" json:"influxfilter,omitempty"`
	TriggerType        string `xorm:"triggertype" binding:"Required;In(DEADMAN,THRESHOLD,TREND)" json:"triggertype"` //deadman|
	IntervalCheck      string `xorm:"intervalcheck" binding:"Required" json:"intervalcheck"`
	OperationID        string `xorm:"operationid" json:"operationid,omitempty"`
	Field              string `xorm:"field" binding:"Required" json:"field"`
	IsCustomExpression bool   `xorm:"iscustomexpression" json:"-"`
	FieldDesc          string `xorm:"fielddesc" json:"-"`
	ExtraData          int64  `xorm:"extradata" json:"-"`
	StatFunc           string `xorm:"statfunc" json:"statfunc,omitempty"`
	CritDirection      string `xorm:"critdirection" json:"critdirection,omitempty"`
	Shift              string `xorm:"shift" json:"shift,omitempty"`
	TrendType          string `xorm:"trendtype" json:"trendtype,omitempty"` //Absolute/Relative
	TrendSign          string `xorm:"trendsign" json:"trendsign,omitempty"` //Positive/Negative
	//thresholds
	//CRITICAL
	ThCritDef         float64 `xorm:"th_crit_def" json:"-"`
	ThCritEx1         float64 `xorm:"th_crit_ex1" json:"-"`
	ThCritEx2         float64 `xorm:"th_crit_ex2" json:"-"`
	ThCritRangeTimeID string  `xorm:"th_crit_rangetime_id" json:"-"`

	//WARN
	ThWarnDef         float64 `xorm:"th_warn_def" json:"-"`
	ThWarnEx1         float64 `xorm:"th_warn_ex1" json:"-"`
	ThWarnEx2         float64 `xorm:"th_warn_ex2" json:"-"`
	ThWarnRangeTimeID string  `xorm:"th_warn_rangetime_id" json:"-"`

	//INFO
	ThInfoDef         float64 `xorm:"th_info_def" json:"-"`
	ThInfoEx1         float64 `xorm:"th_info_ex1" json:"-"`
	ThInfoEx2         float64 `xorm:"th_info_ex2" json:"-"`
	ThInfoRangeTimeID string  `xorm:"th_info_rangetime_id" json:"-"`
	...
	//Grafana dashboard
	GrafanaServer      string `xorm:"grafana_server" json:"-"`
	GrafanaDashLabel   string `xorm:"grafana_dash_label" json:"-"`
	GrafanaDashPanelID string `xorm:"grafana_panel_id" json:"-"`
	ProductTag         string `xorm:"producttag" json:"-"`
	DeviceIDLabel      string `xorm:"deviceid_label" json:"-"`
	ExtraTag           string `xorm:"extra_tag" json:"-"`
	ExtraLabel         string `xorm:"extra_label" json:"-"`
	AlertExtraText     string `xorm:"alert_extra_text" json:"alert_extra_text,omitempty"`
	//Where to deploy this rule
	KapacitorID string `xorm:"kapacitorid" binding:"Required" json:"kapacitorid"`

	Endpoint                []string  `xorm:"-" json:"-"` //relation with endpointcfgs
	Modified                time.Time `xorm:"modified" json:"-"`
	ServersWOLastDeployment []string  `xorm:"servers_wo_last_deployment" json:"-"`
	LastDeploymentTime      time.Time `xorm:"last_deployment_time" json:"-"`
}
