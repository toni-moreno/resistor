...
export class TemplateComponent implements OnInit {
  ...
  createStaticForm() {
    this.sampleComponentForm = this.builder.group({
      ...
      TrigerType: [this.sampleComponentForm ? this.sampleComponentForm.value.TrigerType : '', Validators.required],
      StatFunc: [this.sampleComponentForm ? this.sampleComponentForm.value.StatFunc : '', Validators.required],
      CritDirection: [this.sampleComponentForm ? this.sampleComponentForm.value.CritDirection : '', Validators.required],
      ThresholdType: [this.sampleComponentForm ? this.sampleComponentForm.value.ThresholdType : '', Validators.required],
